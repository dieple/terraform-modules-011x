...
apt-get -y update
apt-get -y install figlet jq make ruby aws-cli vim bzip2 curl git htop iftop inotify-tools iotop lsof lzop netcat net-tools ntp python-pip python-selinux screen strace tcpdump tcptraceroute telnet tree unzip wget
...
sudo echo ${public_key} >> /home/${ssh_user}/.ssh/authorized_keys
