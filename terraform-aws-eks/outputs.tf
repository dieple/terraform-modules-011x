...
output "config_map_aws_auth_filename" {
  description = "A kubernetes configuration to authenticate to this EKS cluster."
  value       = "${element(concat(local_file.config_map_aws_auth.*.filename, list("")), 0)}"
}
